    ...
    <header className="hero">
      <div className="hero-inner">
        <div className="hero-copy">
          ...
          <div className="hero-cta">
            ...
            <div className="hero-visual hero-visual--mobile">
              ...
              <img src="/271shots_so.png" alt="Puente app" className="hero-phone-img" width={1080} height={1920} />
            </div>
        ...
        <div className="hero-visual hero-visual--desktop">
          <span className="hero-glow" />
          <img src="/271shots_so.png" alt="Puente app" className="hero-phone-img" width={1080} height={1920} fetchPriority="high" />
        </div>
      </div>
    </header>
  )
